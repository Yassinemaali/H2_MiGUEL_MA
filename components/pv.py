...
class PV:
    ...
    def __init__(self,
        ...
        # Libraries
        self.module_lib = pd.read_csv (r'C:\Users\yessi\OneDrive\Documents\MasterEE\Masterarbeit\Code\Miguel\miguel-master\miguel-master\data\CEC Modules.csv', sep=',', skiprows=[1,2])

        self.inverter_lib = pd.read_csv(r'C:\Users\yessi\OneDrive\Documents\MasterEE\Masterarbeit\Code\Miguel\miguel-master\miguel-master\data\sam-library-cec-inverters-2019-03-05.csv', sep= ',', skiprows=[1,2])
